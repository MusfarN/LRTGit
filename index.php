...
<html lang="en">
  <head>
    ...
    <title>HOME | LET'S READ TOGETHER</title>
          ...
          <div class="col-sm-9">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a  href="#">NEED BASED APPLICATION</a></li>
            ...
            <div class="row">
                <div class="container">
                    <div class="col-sm-7">
                        ...
                        <h5>Let’s read together is a motivational initiative by The Book Store  
                            which we have taken to create more chances to flourish the culture of reading among more and more people by the method of share and care. This sole purpose of this initiative is 
                            to get students and readers close and give such people a better reading experience who cannot afford having books. </h5>
                    </div>
                    <div class="col-sm-5">
                        <img src="assets/img/about.jpg" alt="about us" width="100%">
                    </div>
                </div>
            </div>
	 	...
	 	<div class="container">
 			<div class="row centered">
 				<div class="col-md-4">
 					...
 					<h4>Caring</h4>
 					<p>If you can’t build a house, place a brick from your side. That’s what caring is all about. If you care for people like you, then show it. Take a stand and we will take care of the rest.</p>
 					<!--<p><br/><a href="#" class="btn btn-theme">More Info</a></p>-->
 				</div>
 				<div class="col-md-4">
 					<i class="fa fa-book"></i>
 					<h4>Donating</h4>
                                        <p>Giving is the most humble impression of love and care. Show your love to the society by donating your books to the people in need. Just sign up with us and we will make sure to get your books to the most deserving.</p>
 					<!--<p><br/><a href="#" class="btn btn-theme">More Info</a></p>-->
 				</div>
 				<div class="col-md-4">
 					<i class="fa fa-group"></i>
 					<h4>Sharing</h4>
                                        <p>Share happiness, be a reason of someone’s comfort. Share your books and help the society to take one more step towards literacy.</p>
 					<!--<p><br/><a href="#" class="btn btn-theme">More Info</a></p>-->
 				</div>		 				
	 		</div>
	 	</div><! --/container -->
	 	...
	 	<div class="container centered">
	 		<div class="row">
	 			...
	 			<i class="fa fa-comment-o"></i>
                                <h1>Happiness is not so much in having as sharing. We make a living by what we get, but we make a life by what we give.</h1>
	 			<h4><br/>Norman Macewan</h4>
	 			<p>Commander, Royal Air Force, Great Britain.</p>
	 			</div>
	 		</div><! --/row -->
	 	</div><! --/container -->
	 </div><! --/twrap -->
